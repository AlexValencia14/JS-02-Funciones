...
/*
Una función es un bloque de codigo que realiza una tarea especifica, cuando se le llama

Cada función de javascript es un objeto Funcion
...
*Seguido de un juego de llaves para cerrar nuestro bloque de codigo.
...
var resultado= suma(4,5); //almacenar función en una variable
...
saludar_nom ("Alejandro");
/**
 La funcion saludar_nom toma un argumento (nombre) y muestra un mensaje en la consola.  Aunque la función no devuelve un valor explícitamente con return, realiza una acción (mostrar un mensaje) cuando se llama.
 */


 //Hoisting (anticipa una función)
 /*
