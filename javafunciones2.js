...
function mezclarJugoDeLimon (cantidadDeJugo, cantidadDeAgua, cantidadDeAzucar) {
 ...
 function prepararLimonada(cantidadDeLimon) {
    ...
    mezclarJugoDeLimon(jugoDeLimon, 200, 5); // Cantidades ficticias de jugo de limon, de agua y de azucar
    servirLimonada();
 }

 // Llamamos a la función principal para preparar limonada
 var vasoDeLimonada = false;
 prepararLimonada(15);//Llamado al programa 

//TAREA: Crear un programa donde verifiquemos un proceso dentro de nuestro consultorio dental